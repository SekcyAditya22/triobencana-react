  ...
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      <div className="flex justify-between items-center">
        <h1 className="text-light-heading dark:text-light-heading md:text-lg lg:text-xl">{position}</h1>
      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-light-heading dark:text-light-heading text-xs md:text-sm font-light pl-1">{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-light-heading dark:text-light-heading text-xs md:text-sm font-light pl-1">{location}</p>
          </div>
        </div>
        <p className="text-light-heading dark:text-light-heading text-xs md:text-sm font-light pl-1 min-w-fit">{duration}</p>
      </div>
    </article>
  );
}
